            ...
            Promise.all(
                ...
                try {
                    for (
                        ...
                        // if (i%3 === 0) {
                        //     box.append(document.createRange().createContextualFragment("<div class='card-deck' id = 'group-" + n + "'></div>"));
                        //     n++
                        // }
                        box.append.apply(
                            box,
                    ...
                    } // box.append(document.createRange().createContextualFragment("</div>"))
                } catch (err) {
